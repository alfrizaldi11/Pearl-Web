                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="wrap-user-picture-circle">
                                        <img id="img_photo_crew" class="primary-user-picture-circle" src="images/icon_nopic.png" />
                                    </div>
                                    <div>
                                ...
                                <div class="col-md-8">
                                    <form>
                                        <div class="form-group content-sign-in">
                                            ...
                                            <input id="nama_crew" type="text" class="form-control input-type-primary-tiketsaya" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                                        </div>
                                        <div class="form-group content-sign-in"">
                                            <label class="title-input-type-primary-tiketsaya"
                                            for="exampleInputEmail1">Status</label>
                                            <select id="status" class="form-control input-type-primary-tiketsaya" required>
                                        ...
                                        <button id="addcrew" type="submit" class="btn btn-success btn-primary-tiketsaya">Add</button>
...
//--------------------------Variabels--------------------------------------------------//
                ...
                var ImgName, ImgUrl, nama_crew, status;
                var files = [];
...
//--------------------------Upload firebase storage--------------------------------------------------//
                ...
                document.getElementById('addcrew').onclick = function(){
                    ImgName = document.getElementById('nama_crew').value;
                    nama_crew = document.getElementById('nama_crew').value;
...
//--------------------------Upload firebase database--------------------------------------------------//
                    function(){
                            uploadTask.snapshot.ref.getDownloadURL().then(function(url){
                                ...
                                firebase.database().ref('crew/'+ImgName).set({
                                    nama_crew: ImgName,
                                    photo_crew: ImgUrl,
                                    status: status
                                });
                                alert('Crew berhasil di tambah');
