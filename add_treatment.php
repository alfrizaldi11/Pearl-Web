                ...
                <div class="item-big-report col-md-12">
                    ...
                    <div class="row">
                        ...
                        <form>
                                ...
                                <div class="form-group content-sign-in"">
                                    <label class="title-input-type-primary-tiketsaya" for="exampleInputEmail1">Group Treatment</label>
                                    <select id="group" class="form-control input-type-primary-tiketsaya">
                                        <option value="">-- Pilih Group Treatment --</option>
                                        <option value="Women-Makeup">Women-Makeup</option>
                                        <option value="Women-Treatment">Women-Treatment</option>
                                        <option value="Women-Hair">Women-Hair</option>
                                        <option value="Men-Cut">Men-Cut</option>
                                        <option value="Men-Treatment">Men-Treatment</option>
                            ...
                            <button id="add" type="submit" class="btn btn-success btn-primary-tiketsaya">Add</button>
...
//--------------------------Variabels--------------------------------------------------//
                ...
                var ImgName, ImgUrl, nama_treatment, keterangan,harga_treatment, Myharga, waktu, Mywaktu, group, deskripsi;
                var files = [];
...
//--------------------------Upload firebase storage--------------------------------------------------//
                ...
                document.getElementById('add').onclick = function(){
                    ...
                    function(error){
                        alert('Gagal menambah treatment');
                    },
...
//--------------------------Upload firebase database--------------------------------------------------//
                    function(){
                            uploadTask.snapshot.ref.getDownloadURL().then(function(url){
                                ...
                                firebase.database().ref('treatment/detail/'+ImgName).set({
                                ...
                                alert('Treatment berhasil di tambah');
