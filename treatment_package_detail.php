...
error_reporting(0);
    ...
    $paket_url = $_GET['nama_treatment'];

    // data detail treatment
    $path_paket_details = 'treatment/paket/'.$paket_url;
        ...
        <div class="row report-group">
            ...
            <div class="col-md-5">
                <div class="item-delete-zone">
                    ...
                    <p class="desc">
                        If yo wanna delete this paket
                    </p>
                    <form method="POST" action="includes/data_model.php">
                    <input type="hidden" name="nama_paket" value="<?php echo $checkdata_paket_details['nama_treatment']; ?>" />
                    <button name="deletePaket" type="submit" onclick="return confirm('Yakin akan dihapus ?');" class="btn-delete btn btn-danger">
                        Delete paket
                    </button>
                    </form>
                </div>
                ...
                <div class="item-big-report col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div style="padding-left: 30px;" class="thumbnail-box col-md-4">
                            ...
                            <img id="img_photo_treatment"  class="thumbnail-wisata" src="<?php echo $checkdata_paket_details['photo_treatment']; ?>" alt="">
                        </div>
                        ...
                        <form method="POST" action="includes/data_model.php">
                                <div class="form-group content-sign-in">
                                    ...
                                    <input disabled name="nama_treatment" value="<?php echo $checkdata_paket_details['nama_treatment']; ?>" type="text" class="form-control input-type-primary-tiketsaya" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                                </div>
                                <div class="form-group">
                                    <label class="title-input-type-primary-tiketsaya" for="exampleInputPassword1">Keterangan</label>
                                    <input name="keterangan" value="<?php echo $checkdata_paket_details['keterangan']; ?>" type="text" class="form-control input-type-primary-tiketsaya" id="exampleInputPassword1" required>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label class="title-input-type-primary-tiketsaya" for="exampleInputPassword1">Harga Treatment</label>
                                            <input name="harga_treatment" value="<?php echo $checkdata_paket_details['harga_treatment']; ?>" type="number" class="form-control input-type-primary-tiketsaya" id="exampleInputPassword1" required>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="waktu" value="<?php echo $checkdata_paket_details['waktu']; ?>" type="number" class="form-control input-type-primary-tiketsaya" id="exampleInputPassword1" required>
                                        </div>
                                        <div style="padding-left: 0px; margin-top: 15px;" class="col-md-1">
                                            <br>
                                            <h6>Menit</h6>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="deskripsi" class="input-type-primary-tiketsaya form-control" id="exampleFormControlTextarea1" rows="8" required><?php echo $checkdata_paket_details['deskripsi']; ?></textarea>
                                </div>
                                <div style="margin-bottom: -40px; visibility: hidden;" class="form-group content-sign-in">
                                        <input id="image_file" type="file" />
                                    </div>
                                
                                <input type="hidden" id="nama_paket" name="paket_url" value="<?php echo $checkdata_paket_details['nama_treatment']; ?>" />
                                <button type="submit" id="updatepaket" name="updatePaket" class="btn btn-success btn-primary-tiketsaya">Update</button>
                                <button style="margin-left: 10px;" type="reset" class="btn btn-cancel-secondary">Cancel</button>
                            </form>
                        </div>
...
//--------------------------Upload firebase storage--------------------------------------------------//
                ...
                document.getElementById('updatepaket').onclick = function(){
                    ImgName = document.getElementById('nama_paket').value;
...
//--------------------------Upload firebase database--------------------------------------------------//
                    function(){
                            uploadTask.snapshot.ref.getDownloadURL().then(function(url){
                                ...
                                firebase.database().ref('treatment/paket/'+ImgName).update({
