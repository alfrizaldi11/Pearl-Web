            ...
            <div class="col-md-12">
                ...
                <nav aria-label="sitemap-ts breadcrumb">
                    <ol class="breadcrumb" style="margin-left: -15px; background: none;">
                        <li class="breadcrumb-item"><a style="color: #C7C7C7;" href="#">Treatment</a></li>
                    ...
                    <div class="row">
                        ...
                        <form method="POST" action="includes/data_model.php">
                                ...
                                <label class="title-input-type-primary-tiketsaya" for="exampleInputEmail1">Photo Treatment</label>
                                    <img class="thumbnail-wisata" src="<?php echo $checkdata_treatment_details['photo_treatment']; ?>" alt="">
                                    <input type="hidden" name="photo_treatment" value="<?php echo $checkdata_treatment_details['photo_treatment']; ?>"/>
                                </div>
                                <div class="form-group content-sign-in">
                                    <label class="title-input-type-primary-tiketsaya" for="exampleInputEmail1">Nama Treatment</label>
                                    <input disabled name="nama_treatment" value="<?php echo $checkdata_treatment_details['nama_treatment']; ?>" class="form-control input-type-primary-tiketsaya"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled name="keterangan" value="<?php echo $checkdata_treatment_details['keterangan']; ?>" class="form-control input-type-primary-tiketsaya"/>
                                    <input type="hidden" name="keterangan" value="<?php echo $checkdata_treatment_details['keterangan']; ?>"/>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input disabled name="harga_treatment" value="<?php echo $checkdata_treatment_details['harga_treatment']; ?>" class="form-control input-type-primary-tiketsaya"/>
                                            <input type="hidden" name="harga_treatment" value="<?php echo $checkdata_treatment_details['harga_treatment']; ?>"/>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input disabled name="waktu" value="<?php echo $checkdata_treatment_details['waktu']; ?>" class="form-control input-type-primary-tiketsaya"/>
                                            <input type="hidden" name="waktu" value="<?php echo $checkdata_treatment_details['waktu']; ?>"/>
                                        </div>
                                        <div style="padding-left: 0px; margin-top: 15px;" class="col-md-1">
                                            <br>
                                            <h6>Menit</h6>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea disabled class="input-type-primary-tiketsaya form-control" id="exampleFormControlTextarea1" rows="8"><?php echo $checkdata_treatment_details['deskripsi']; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label class="title-input-type-primary-tiketsaya"
                                ...
                                <input type="hidden" name="treatment_url" value="<?php echo $checkdata_treatment_details['nama_treatment']; ?>" />
                                ...
                                <button type="submit" name="pilihTreatment" class="btn btn-success btn-primary-tiketsaya">Save</button>
                            </form>
                        </div>
