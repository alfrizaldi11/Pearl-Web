        ...
        <div class="header row">
            <div class="col-md-12">
                ...
                <p class="sub-header-title">
                    Manage antrians that exist in the system
                </p>
            </div>
        </div>
                    ...
                    <table class="table-wisata table-tiketsaya table table-borderless">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="antrian_detail.php?nama_crew=<?php echo $print_data_schedule['nama_crew'];?>&tanggal=<?php echo $print_data_schedule['tanggal'];?>" class="btn btn-small-table btn-primary ">Details</a>
                                </td>
                            </tr>
                        <?php } ?>
